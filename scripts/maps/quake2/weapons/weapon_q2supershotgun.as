namespace q2supershotgun
{

const string WEAPON_NAME				= "weapon_q2supershotgun";

const int Q2W_DEFAULT_GIVE				= 26;

const float Q2W_DAMAGE					= 4;
const float Q2W_PELLETS					= 20;
const float Q2W_RECOIL						= -2.0;
const float Q2W_TIME_DELAY				= 1.1;
const float Q2W_TIME_DRAW				= 0.7;
const float Q2W_TIME_IDLE				= 4.0; //length of animation
...
const string MODEL_VIEW					= "models/quake2/weapons/v_supershotgun.mdl";
const string MODEL_PLAYER				= "models/quake2/weapons/p_supershotgun.mdl";
const string MODEL_WORLD				= "models/quake2/weapons/w_supershotgun.mdl";
...
const array<string> pQ2WSounds =
{
	...
	"quake2/weapons/sshotf1b.wav"
};

class weapon_q2supershotgun : CBaseQ2Weapon
{
	private float m_flStopCockSound;
	...
	bool GetItemInfo( ItemInfo& out info )
	{
		...
		info.iSlot				= q2weapons::SUPERSG_SLOT - 1;
		info.iPosition			= q2weapons::SUPERSG_POSITION - 1;
		info.iWeight			= q2weapons::SUPERSG_WEIGHT;
	...
	void PrimaryAttack()
	{
		...
		self.SendWeaponAnim( (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) > 1) ? ANIM_SHOOT : ANIM_SHOOT_LAST );
		...
		Vector vecAim1 = g_Engine.v_forward + g_Engine.v_right * -0.05;
		Vector vecAim2 = g_Engine.v_forward + g_Engine.v_right * 0.05;

		if( !m_bUseQ2Bullets )
		{
			fire_shotgun( vecMuzzle, vecAim1, flDamage, Q2W_PELLETS/2 );
			fire_shotgun( vecMuzzle, vecAim2, flDamage, Q2W_PELLETS/2 );
		}
		else
		{
			vecAim1.z = -vecAim2.z;
			...
			q2::fire_shotgun( m_pPlayer, vecMuzzle, vecAim1, flDamage, flKick, q2::DEFAULT_SHOTGUN_HSPREAD, q2::DEFAULT_SHOTGUN_VSPREAD, q2::DEFAULT_SSHOTGUN_COUNT/2, q2::MOD_SSHOTGUN );
			q2::fire_shotgun( m_pPlayer, vecMuzzle, vecAim2, flDamage, flKick, q2::DEFAULT_SHOTGUN_HSPREAD, q2::DEFAULT_SHOTGUN_VSPREAD, q2::DEFAULT_SSHOTGUN_COUNT/2, q2::MOD_SSHOTGUN );
		}

		if( m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 1 )
			m_flStopCockSound = g_Engine.time + 0.42;
	...
	void ItemPostFrame()
	{
		if( m_flStopCockSound > 0.0 and m_flStopCockSound < g_Engine.time )
		{
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "q2supershotgun::weapon_q2supershotgun", WEAPON_NAME );
	g_ItemRegistry.RegisterWeapon( WEAPON_NAME, "quake2/weapons", "q2shells" );
}

} //namespace q2supershotgun END
