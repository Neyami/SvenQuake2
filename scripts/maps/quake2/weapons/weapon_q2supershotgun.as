...
class weapon_q2supershotgun : CBaseQ2Weapon
{
	...
	void PrimaryAttack()
	{
		...
		Vector vecAim = g_Engine.v_forward + g_Engine.v_right * -0.05;
		fire_shotgun( vecMuzzle, vecAim, flDamage, Q2W_PELLETS/2 );

		vecAim = g_Engine.v_forward + g_Engine.v_right * 0.05;
		fire_shotgun( vecMuzzle, vecAim, flDamage, Q2W_PELLETS/2 );
