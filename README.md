...
q2jorgarena ends after killing the boss.  
The deathmatch maps are unfinished, but I've provided the sources (.map and .jmf for J.A.C.K.)  
stadium4q2 is a modified version of stadium4 for testing the NPCs  
